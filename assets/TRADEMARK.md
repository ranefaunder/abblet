...
> Tämä on **desktop-selvitys**, ei asianajajan lausunto eikä tyhjentävä clearance.  
> Ennen hakemusta: viralliset haut ([TMview](https://www.tmdn.org/tmview/), [USPTO](https://tmsearch.uspto.gov/), [PRH](https://tavaramerkkitietopalvelu.prh.fi/)) + IP-asiamies.
...
| Suositus | Etene EUIPO (+ tarvittaessa FI) hakemukseen luokissa **9 + 42** (+ harkitse **35**), logofiguratiivinen tuki; tee asiamiehen clearance |

**Ei “vihreää valoa” eikä “punaista stoppia”** — tilanne on tyypillinen coined-but-suggestive tech-nimelle: tilaa on, mutta *Remix*-ekosysteemi ja äänimerkki `R-MIX` ovat huomioitavia.

---

## Ehdotetut tavarat / palvelut (Nice)

| Luokka | Esimerkkikuvaus (luonnos) |
|--------|---------------------------|
| **9** | Ladattavat mobiili- ja tietokonesovellukset; PWA:t; ohjelmistot sovellusten rakentamiseen ja jakeluun |
| **42** | SaaS / PaaS: sovellusten generointi, remiksaus, hostaus; AI-avusteinen sovelluskehitys palveluna; digitaalinen app store -alusta |
| **35** (valinnainen) | Online-vähittäiskauppa / välitys digitaalisille sovelluksille; sovelluskaupan ylläpito |

Täsmälliset ID:t TM5 / EUIPO-listasta asiamiehen kanssa.

---

## Löydetyt / huomionarvoiset osumat
...
| **RMIX** (PL yhtiöitä ym.) | Sekalainen | **Matala** (ei näytä softa-appstorelta) |
| **RMIX Service** ([rmixservice.com](https://www.rmixservice.com/) — live audio mixing) | Audio / live mixing | **Matala–keskitaso** (ääni vs. app store; sama kirjainjono) |

Julkisessa haussa **ei löytynyt** selkeää, aktiivista EU/US-sanamerkkiä muodossa `RMIX` nimenomaan **sovelluskauppa / AI-app builder** -palveluille. Tämä **ei korvaa** TMview/TESS-hakuja.

### 2. Foneettisesti / käsitteellisesti läheiset (`Remix`, `R-MIX`)

| Merkki / toimija | Ala | Riski |
|------------------|-----|-------|
...
- **Figuratiivinen logo** (nykyinen wordmark + neliöt) kannattaa hakea **sanan lisäksi** tai ensisijaisesti.

---

## Riskitasot (käyttö vs. rekisteröinti)

1. **Käyttö Suomessa / EU:ssa App Store -brändinä**  
   - Todennäköisin konflikti: **sekavuus Remix / R-MIX** -maineeseen ja mahdollisiin softaluokan Remix-merkkeihin.  
   - Eri alojen `rMIX` (kierrätys, audio) harvemmin estävät, mutta voivat vaikeuttaa domain/SEO/brändiä.

2. **Rekisteröinnin onnistuminen (EUIPO)**  
   - Mahdollinen, jos luokkalistaus on tarkka ja logo tukee.  
   - Riski: absolute grounds (kuvailevuus) + relative grounds (läheiset Remix / MIX -merkit softassa).

3. **USA**  
   - Erillinen selvitys pakollinen ennen USPTO-hakemusta; `REMIX`-hakemushistoria on aktiivinen.
...
- EUIPO / TMview -ohjeet: https://www.euipo.europa.eu/  
- PRH tavaramerkkihaku: https://tavaramerkkitietopalvelu.prh.fi/  
- Roland R-MIX: https://www.roland.com/us/products/rc_r-mix/  
- Remix framework: https://remix.run/  
- rMIX recycling: https://www.rmix.it/  
- Esimerkkejä Remix-tavaramerkeistä (muoti ym.): TrademarkElite / EUIPO public records  

---

## Linkki brändiin

Slogan, hissipuhe ja assetit: [`BRAND.md`](BRAND.md).
