...
export const translations = {
  ...
  "Monthly grant": { fi: "Kuukausittainen saldo" },
  "Free": { fi: "Free" },
  "Premium": { fi: "Premium" },
  "Plan": { fi: "Tilaus" },
  "Current": { fi: "Nykyinen" },
  ...
  "Cancel Premium": { fi: "Peruuta Premium" },
  "Cancel Premium?": { fi: "Perutaanko Premium?" },
  "Switch to Free": { fi: "Vaihda Free-tilaukseen" },
  "Keep Premium": { fi: "Pidä Premium" },
  ...
  "Usage history": { fi: "Käyttöhistoria" },
  "Soon": { fi: "Pian" },
  "Next: +$amount on $date": { fi: "Seuraava: +$amount $date" },
  "Next: tops up to $amount on $date": { fi: "Seuraava: täydennetään $amount $date" },
  "Paid through $date": { fi: "Maksettu $date asti" },
  "Next bill on $date": { fi: "Seuraava laskutus $date" },
  ...
  "Your current plan": { fi: "Nykyinen tilauksesi" },
  ...
  "Create your own apps with AI": { fi: "Luo omia appeja tekoälyllä" },
  "Install apps to your home screen": { fi: "Asenna apit kotinäytölle" },
  "Everything in Free": { fi: "Kaikki Freen ominaisuudet" },
  ...
  "$5.99/mo": { fi: "$5.99/kk" },
  "Gift code": { fi: "Lahjakoodi" },
  "Have a gift code?": { fi: "Onko sinulla lahjakoodi?" },
  "Enter a gift code": { fi: "Syötä lahjakoodi" },
  "Redeem": { fi: "Lunasta" },
  "Redeeming…": { fi: "Lunastetaan…" },
  ...
  "That gift code is not valid.": { fi: "Lahjakoodi ei kelpaa." },
  ...
  "Go to Me for Premium": { fi: "Siirry Me-sivulle Premiumiin" },
  "Price": { fi: "Hinta" },
  ...
  "This app needs permission to": { fi: "Appi tarvitsee luvan" },
